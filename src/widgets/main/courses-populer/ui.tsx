...
const CoursesPopuler: FC = () => {
  return (
    <div className="flex flex-col gap-[21px] w-[292px] pl-[21px] pr-[25px] pt-[32px] pb-[54px] rounded-[32px] bg-white text-xs">
      <div>
        <div className="flex justify-between font-medium text-sm mb-[20px]">
          <h3 className="font-medium">Courses Populer</h3>
          <MoreButton arrowPosition="right" />
        </div>
        <div className="flex flex-col gap-[5px] mt-[7px]">
          <div className="flex items-center justify-between">
            <div className="flex flex-col gap-[5px]">
              <p className="max-w-[197px] text-xs font-medium">
          ...
          <p className="text-darkGreen text-sm font-medium mt-[20px]">
            Courses Populer
          </p>
        </div>
      </div>
